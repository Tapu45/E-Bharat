    ...
    <div className='bg-white sticky top-0 z-50'>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <Link to={'/'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === "rameswarpanda891@gmail.com" ? <div className="flow-root">
      ...
      <header className="relative bg-white">
        ...
        style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
         shop now and reap the rewards of massive discounts!
        </p>
          ...
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <Link to={'/'} className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Home
                  </Link>
                  <Link to={'/allproducts'} className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    All Products
                  </Link>
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Order
                  </Link> :   <Link to={'/signup'}  className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Signup
                    </Link>}

                  {/* {user?.user?.email === 'rameswarpanda891@.com' ? 
                   <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link> : ""} */}
                  {user?.user?.email === "rameswarpanda891@gmail.com" ? <div className="flow-root">
                    <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 hover:text-yellow-400" style={{ color: mode === 'dark' ? 'white' : '', }}>
                 ...
                 {user ?  <a onClick={logout} className="text-sm font-medium text-gray-700 cursor-pointer hover:text-yellow-400 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Logout
                  </a> : ""}
                </div>

                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 hover:text-yellow-400">
                    <img
